...
export const constantRouterMap = [
    ...
    {path:'/platfrom',component:Platfrom,meta: { role: ['admin'] }},
...
export const asyncRouterMap = [

 {
    ...
    children: [
     ...
     {path: '/introduction',name: '在线震动监测',icon:'thumbsup',component: _import('Introduction')},
     {path: '/components',name: '应力监测',redirect: '/components/buttons',icon:'bookmark',
       ...
       {path: '/charts',name: '消防安全',redirect: '/charts/shopchart',icon:'pie-graph',
        // component: {render (c) { return c('router-view') }},
...

   {
    ...
    hidden:false,
    children: [
      {path: '/home1/manager',name: '首页',icon:'speedometer',component: _import('Dashboard2'),meta: { role: ['admin'] }},
      {path: '/home1/introduction',name: '设备监控',icon:'thumbsup',component: _import('Introduction')},
      {path: '/components',name: '应力监测',redirect: '/components/buttons',icon:'bookmark',
      component: {render (c) { return c('router-view') }},
      children: [ 
                  {path: 'buttons',name: 'Buttons按钮',icon:'social-youtube',component: _import('components/Buttons'), hidden:false, },
